...
public class AuswertungDurchMQTTEinZeigerSENDER {
    @SneakyThrows
    public static void main(String[] args) {
        ...
        List<Path> files = listFiles(Paths.get("data/example/gauge"));

        for (int i = 0; i < files.size(); i++) {
            String t = "turboSniffle/roundGauge/onePointer/" + i + "/greyscale";
