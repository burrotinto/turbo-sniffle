...
import de.burrotinto.turboSniffle.cv.HeatMap;
...
public class GaugeFactory {
    ...
    public static Gauge getGauge(Mat src,int bilateral) {
        ...
        try {
            ...
            log.info("Fitting Ellipse Methode fehlgeschlagen bei: " + src.toString());
        }
        try {
            if (out == null) {
            ...
            log.info("Heatmap Methode fehlgeschlagen bei: " + src.toString());
        }
        return out;
    }
