...
//        Imgproc.threshold(srcGray,srcGray,63,255,Imgproc.THRESH_BINARY);
    ...
    public static void main(String[] args) {
        ...
        javax.swing.SwingUtilities.invokeLater(new Runnable() {
            @Override
            public void run() {
//                new FindContours2("pic/analog/unnamed.jpg");
                new CircleExtractor().getAllCircles(Imgcodecs.imread("sixpacks/sixpack.jpg")).forEach(FindContours2::new);
