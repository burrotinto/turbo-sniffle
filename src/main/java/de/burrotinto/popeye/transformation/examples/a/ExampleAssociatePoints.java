...
//		Class imageType = GrayU8.class;
        ...
        DetectDescribePoint detDesc = FactoryDetectDescribe.
				sift(new ConfigCompleteSift(0,5,600),imageType);
//                surfStable(new ConfigFastHessian(1, 2, 300, 1, 9, 4, 4), null,null, imageType);

        ScoreAssociation scorer = FactoryAssociation.scoreEuclidean(detDesc.getDescriptionType(),true);
        ...
        BufferedImage imageB = UtilImageIO.loadImage(UtilIO.pathExample("C:\\Users\\fklinger\\IdeaProjects\\turbo-sniffle3\\data\\example\\images (8).jpg"));
        BufferedImage imageA = UtilImageIO.loadImage(UtilIO.pathExample("C:\\Users\\fklinger\\IdeaProjects\\turbo-sniffle3\\sixpacks\\round-1195885442.jpg"));
