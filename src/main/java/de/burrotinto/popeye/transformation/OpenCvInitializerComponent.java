...
public class OpenCvInitializerComponent {
    ...
    private void init() {
        ...
        String filename = "sixpacks/sixpack.jpg";

        // Load an image
        Mat src = Imgcodecs.imread(filename, Imgcodecs.IMREAD_COLOR);


//        HighGui.imshow("detected circles ", getHoughPTransform(src, 0.1, 0.5, 2));

//        rectangleExtractor.getAllRectangels( Imgcodecs.imread("20201109_140917_resized.jpg", Imgcodecs.IMREAD_COLOR));
